...
import getUserLang from './api/getUserLang';
=======
// FILES
...
<<<<<<< HEAD
    useEffect(() => {
        const fetchData = async () => {
            let userLanguages = await getUserLang({'uid' : "OUnW07Np3VNFduMOCX1V1bvvsd22"});
        ...
        // const fetchData = async () => {
        //     let getLandData = await getLangData();
        //     setData(getLandData)
        // };
...
<<<<<<< HEAD
                <Content style={{
                    ...
                    >
                        <Meta title="LANG NAME PLACEHOLDER" description="LANGUAGE URL"/>
                    </Card>
                </Content>
=======
                    <Content style={{
